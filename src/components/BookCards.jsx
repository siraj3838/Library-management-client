...
const BookCards = () => {
    ...
    axios.get('http://localhost:5005/bookCategory')
        .then(res => {
        ...
        <div className="px-5 lg:px-0 mt-10">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between max-w-screen-xl mx-auto">
                <div className="flex">
                    ...
                    <h3 className="text-xl font-bold">Please Click Your Favorite Category</h3>
                </div>
                <div className="my-10">
                    <div className="grid md:grid-cols-2 gap-10">
                        {
                            booksList.map(book => <div className="rounded-lg shadow-2xl py-3 glass" key={book._id}>
                                ...
                                <div className="flex justify-center items-center">
                                    <button className="bg-gradient-to-r from-red-500 to-pink-600 font-bold px-2 py-2 rounded-md text-white hover:text-gray-400 duration-300">Show Books</button>
                                </div>
                            </div>)
                        }
                    </div>
