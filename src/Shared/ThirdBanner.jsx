...
const ThirdBanner = () => {
    return (
        <div>
            <h2 className="text-5xl font-bold text-center border-b-2 border-black lg:mx-96 pb-4">Our Book Event Calender</h2>
            <div className="flex flex-col md:flex-row justify-center items-center gap-6 max-w-screen-lg mx-auto">
                <div>
                    <h3 className="text-4xl font-bold"><span className="italic">Events</span> Calendar</h3>
